...
(function($){
    $.fn.slider =function(ops){
        ops = $.extend({
            ...
            btnW:30, //按钮宽度
            btnH:30, //按钮高度
            btnbk_left:'url("img/left.png") no-repeat center',//按钮背景
            btnbk_right:'url("img/right.png") no-repeat center',
            mouse_btnleft:'url("img/chick_left.png") no-repeat center',//鼠标悬停背景
            mouse_btnright:'url("img/chick_right.png") no-repeat center'
        },ops||{});
